...
abstract contract StdAssertions {
    ...
    event LogNamedAddress(string key, address val);
    event LogNamedBytes32(string key, bytes32 val);
    event LogNamedDecimalInt(string key, int256 val, uint256 decimals);
    event LogNamedDecimalUint(string key, uint256 val, uint256 decimals);
    event LogNamedInt(string key, int256 val);
    event LogNamedUint(string key, uint256 val);
    event LogNamedBytes(string key, bytes val);
    event LogNamedString(string key, string val);

    event LogArray(uint256[] val);
    event LogArray(int256[] val);
    event LogArray(address[] val);
    event LogNamedArray(string key, uint256[] val);
    event LogNamedArray(string key, int256[] val);
    event LogNamedArray(string key, address[] val);
